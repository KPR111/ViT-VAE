"""
Simplified training script for the Variational Autoencoder (VAE) in PyTorch.
This version removes some complexity to avoid potential errors.
"""
import os
import torch
...
def train_vae_simple(epochs=VAE_EPOCHS):
    """
    ...
    for epoch in range(epochs):
        ...
        checkpoint_path = os.path.join(VAE_CHECKPOINTS_PATH, f"vae_weights_epoch_{epoch+1:02d}.pt")
        torch.save({
            'epoch': epoch + 1,
