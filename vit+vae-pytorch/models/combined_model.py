...
from config.model_config import IMAGE_SIZE, IMAGE_CHANNELS, LATENT_DIM
...
class CombinedModel(nn.Module):
    ...
    def __init__(self, encoder, decoder, vit_classifier, batch_size, train_data_size):
        ...
        self.annealing_epochs = 10  # Number of epochs to gradually increase KL weight
        self.kl_weight_max = 0.0001  # Maximum KL weight
...
if __name__ == "__main__":
    ...
    targets = torch.randint(0, 38, (batch_size,)).to(device)
